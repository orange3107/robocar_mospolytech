...
class SerialControl(Node):
	...
	def __init__(self):
		...
		self.timer_odom = self.create_timer(0.1, self.timer_odom_callback)
		...
		self.sub_odom = self.create_subscription(
            Odometry, '/autocar/odom', self.odom_callback, 10)
	...
	def timer_odom_callback(self):
		...
		#transform_stamped_msg.transform.translation = self.odom.pose.pose.position
		transform_stamped_msg.transform.translation.x = self.odom.pose.pose.position.x
		transform_stamped_msg.transform.translation.y = self.odom.pose.pose.position.y
		transform_stamped_msg.transform.translation.z = self.odom.pose.pose.position.z

		#transform_stamped_msg.transform.rotation = self.odom.pose.pose.orientation
		transform_stamped_msg.transform.rotation.x = self.odom.pose.pose.orientation.x
		transform_stamped_msg.transform.rotation.y = self.odom.pose.pose.orientation.y
		transform_stamped_msg.transform.rotation.z = self.odom.pose.pose.orientation.z
		transform_stamped_msg.transform.rotation.w = self.odom.pose.pose.orientation.w
